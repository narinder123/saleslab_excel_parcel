...
export const createDeductibleModifiers = (
              ...
              rateTableData.push({
                ...
                rates: filteredRates.map((premium): RateTableCustomerPrice => {
                  let value: RateTableCustomerPrice = {
                    ...
                    price: {
                      currency: `-Enum.currency.${multiCurrency ? premium.currency : InsurerInfo.currency}-`,
                      price: Number(premium.rates) / InsurerInfo.conversion,
                    },
                  };
              ...
              customConditionsArr.map((condition: string, i: number) => {
                ...
                if (tempOption.premiumMod) {
                  if (!rateTableStatus) {
                    ...
                    tempOption.premiumMod.conditionalPrices = baseAnnualPremium;
                  } else {
  ...
  return { data: [deductible], splitFile: splitArr, rateTableData };
};
